...
echo ============================================================
echo AMSRAG Web Backend Launcher
echo ============================================================
...
echo [ERROR] This usually means an old backend process is still running, so your latest code changes will not take effect.
echo [HINT] Stop the existing backend window or kill PID !PORT_PID!, then restart.
echo [HINT] For development, use backend\start-dev.bat to enable auto reload.
pause
exit /b 1
