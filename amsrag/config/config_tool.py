...
def main():
    parser = argparse.ArgumentParser(description="amsrag 配置管理工具")
    subparsers = parser.add_subparsers(dest='command', help='可用命令')
    
    # 创建配置文件命令
    create_parser = subparsers.add_parser('create', help='创建配置文件')
    create_parser.add_argument('output', help='输出配置文件路径')
    create_parser.add_argument('--working-dir', default='./amsrag_cache', help='工作目录')
