...
import numpy as np
from nano_vectordb import NanoVectorDB  # 第三方库
...
@dataclass
class SimpleVectorDBStorage(BaseVectorStorage):
    """简单向量数据库存储（基于nano_vectordb库）"""
    ...
    def __post_init__(self):
        ...
        # 获取嵌入维度，如果embedding_func是函数则使用默认维度
